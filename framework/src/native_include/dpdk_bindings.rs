...
pub const RTE_EAL_PMD_PATH: &[u8; 47usize] = b"/usr/local/lib/x86_64-linux-gnu/dpdk/pmds-21.0\0";
...
pub const RTE_NET_IPN3KE: u32 = 1;
...
pub const RTE_VER_RELEASE: u32 = 4;
pub const RTE_VER_SUFFIX: &[u8; 4usize] = b"-rc\0";
...
pub type rte_timer_type = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Copy, Clone)]
...
extern "C" {
    pub fn rte_pci_device_name(addr: *const rte_pci_addr, output: *mut ::std::os::raw::c_char, size: size_t);
}
extern "C" {
